...
class BaseGlassDoorScraper(BaseScraper):
    ...
    def get_search_url(self,
        ...
        if method == 'get':
            ...
            return f'https://www.glassdoor.{self.config.search_config.domain}/Job/jobs.htm?clickSource=searchBtn&sc.keyword={self.query}&locT=C&locId={location_id}&jobType=&radius={self.quantize_radius(self.config.search_config.radius)}'
        elif method == 'post':
